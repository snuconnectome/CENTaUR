#!/bin/bash
#SBATCH --job-name=fit_deepseek
#SBATCH --partition=octopus
#SBATCH --nodelist=node1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=02:00:00
#SBATCH --output=/scratch/connectome/connectome1/ko-centaur/logs/fit_deepseek_%j.out
#SBATCH --error=/scratch/connectome/connectome1/ko-centaur/logs/fit_deepseek_%j.err

# ============================================================
# CENTaUR 100-fold LOO Cross-Validation - DeepSeek-R1
# ============================================================
#
...
echo "Model: DeepSeek-R1-32B-QLoRA"
echo "=================================="
echo ""
...
FEATURES_FILE="data/features/centaur_features_deepseek.pth"
if [ ! -f "$FEATURES_FILE" ]; then
    echo "ERROR: Features file not found!"
    echo "Please run feature extraction first:"
    echo "  sbatch scripts/submit_extract_deepseek.sh"
    exit 1
fi
...
# Show output
OUTPUT_FILE="data/results/loo_cv_results_deepseek.pth"
