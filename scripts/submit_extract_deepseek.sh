#!/bin/bash
#SBATCH --job-name=extract_deepseek
...
#SBATCH --output=/scratch/connectome/connectome1/ko-centaur/logs/extract_deepseek_%j.out
#SBATCH --error=/scratch/connectome/connectome1/ko-centaur/logs/extract_deepseek_%j.err

# ============================================================
# CENTaUR Feature Extraction - DeepSeek-R1
# ============================================================
#
# Purpose: Extract last-layer hidden states from fine-tuned
#          DeepSeek-R1-Distill-Qwen-32B for CENTaUR evaluation
#
# Expected:
...
# Show output
OUTPUT_FILE="/scratch/connectome/connectome1/ko-centaur/data/features/centaur_features_deepseek.pth"
